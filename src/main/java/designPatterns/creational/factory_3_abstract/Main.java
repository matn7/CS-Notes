...
import designPatterns.creational.factory_3.Plane;
...
public class Main {
    ...
    // AbstractFactory defines the interface that all of the concrete fatories will need to implement to product products.
    ...
    // Clienkt is totally decoupled from concrete product.
