package mutithreading.simulationsAndMultithreading.semaphores;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // acquire() - if permits is availablethen takes it
    ...
    // Binary Semaphores - Semaphores restricted to values o and 1
    ...
    // Mutexes
    // Mutex is esentially a binary semaphore
    // - Mutex has a concept of an owner. Only process that locked the mutex is supposed to unlock it.
    // - Can provide deletion safety
    // - May provide prioritity inversion safety. If the mutex knows its current owner, it is possible
    // to promote the prioritity of the owner whenever a higher prioritity task starts waiting on the mutex.
