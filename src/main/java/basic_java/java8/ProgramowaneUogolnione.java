...
public class ProgramowaneUogolnione {
    ...
    // Problem z zanieczyszczeiem sterty polega na tym, że błąd zgłoszony podczas działania kodu jest daleki
    // od prawdziwego źródła problemu wstawiania niewłaściwego elementu.
    // Jeśli musisz debugować taki problem, możesz skorzystać z kontrolowanego widoku (ang. checked view).
    ...
    // Nie możesz wyrzucić lub przechwycić obiektów klasy uogólnionej.
    // Nie możesz utworzyć uogólnionej klasy rozszerzającej Throwable.

    // Refleksje i uogólnienia
    // Klasa Class<T>
    // Możesz użyć obiektu tej klasy by ustalić jakie metody ma klasa, lub skonstruować inną jej instancję.
