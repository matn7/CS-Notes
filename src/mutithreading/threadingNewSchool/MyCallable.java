...
public class MyCallable implements Callable<Integer> {
    ...
    // concurrency libraruies in Java) has 2 important advantages over Runnable.
    ...
    // As we saw previously shared memory leads to all kind of complicatios around memory errors.

    // 2. In Callable, it is possible for the .call method to throw exception and for these
    // exceptions to be cough and handled by the main thread. This is a major advantage - otherwise it is difficult
